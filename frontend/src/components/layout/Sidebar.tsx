    ...
    <aside className="glass-soft w-48 shrink-0 flex flex-col rounded-2xl border-none">
      ...
      <div className="flex flex-col px-2 pb-5 gap-1">
        ...
        <div className="flex items-center gap-2 px-3 py-2 mt-1 bg-white/30 rounded-xl mx-1">
          <div className="w-7 h-7 rounded-full bg-amber-400 flex items-center justify-center text-[11px] font-semibold text-white select-none shrink-0 shadow-sm">
            {avatarChar}
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-[11px] text-[#1A1A1A] font-semibold truncate leading-tight">
              {displayName}
            </div>
