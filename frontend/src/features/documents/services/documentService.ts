...
export const documentService = {
  list: (kbName: string, page: number, pageSize: number, docType?: string) =>
    documentApi.list(kbName, page, pageSize, docType),
  ...
  reindex: (kbName: string, docId: number) => documentApi.reindex(kbName, docId),
  ...
  discardDoc: (kbName: string, docId: number) => documentApi.delete(kbName, docId),
  getDownloadToken: (downloadUrl: string) => documentApi.getDownloadToken(downloadUrl),
