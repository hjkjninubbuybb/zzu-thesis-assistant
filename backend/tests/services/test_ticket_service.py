...
def test_list_tickets_teacher(svc, mock_ticket_store):
    ...
    mock_ticket_store.list_qa_requests.assert_called_once_with(mentor_id=9, page=1, page_size=20)
...
def test_list_tickets_admin(svc, mock_ticket_store):
    ...
    mock_ticket_store.list_qa_requests.assert_called_once_with(page=1, page_size=20)
