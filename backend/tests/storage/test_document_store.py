...
class TestKnowledgeBase:
    ...
    def test_delete_kb_cascades_documents(self, ds):
        ...
        docs, _ = ds.list_documents("del_kb")
        assert len(docs) == 0
...
class TestDocument:
    ...
    def test_list_documents_ordered_by_created_desc(self, ds):
        ...
        docs, total = ds.list_documents("doc_test_kb")
        assert total == 2
...
class TestFAQ:
    ...
    def test_list_faqs_enabled_only(self, ds):
        ...
        enabled, _ = ds.list_faqs("faq_kb", enabled_only=True)
    ...
    def test_list_faqs_by_status(self, ds):
        ...
        approved, _ = ds.list_faqs("faq_kb", status="approved")
    ...
    def test_list_faqs_order_by_sort_order(self, ds):
        ...
        faqs, total = ds.list_faqs("faq_kb")
        assert total == 2
...
class TestQARequest:
    ...
    def test_list_qa_requests_by_mentor(self, ds):
        ...
        results, _ = ds.list_qa_requests(mentor_id=self.mentor["id"])
    ...
    def test_list_qa_requests_by_status(self, ds):
        ...
        pending, _ = ds.list_qa_requests(status="pending")
        assert len(pending) == 1
        ds.update_qa_request(req["id"], "A1", status="replied")
        pending_after, _ = ds.list_qa_requests(status="pending")
